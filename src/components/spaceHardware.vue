          ...
          <div>
            ...
            <div class="time flex">
              <el-select v-model="regionData.regionValue" class="m-region" placeholder="Region">
                <el-option v-for="item in regionData.regionOption" :key="item.value" :label="item.label"
                           :value="item.value"/>
              </el-select>
            </div>
          </div>
            ...
            <div class="title_tip flex">
              <div class="flex">
                ...
                <el-popover placement="top-start" :width="200" trigger="hover"
                            content="If the task isn't successfully taken by the CP within the specified time, we will consider it a failed and refund your tokens.">
                  <template #reference>
                    <div>
                      <svg class="" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
                           aria-hidden="true" focusable="false" role="img" width="1em" height="1em"
