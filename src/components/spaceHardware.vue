        ...
        <el-row class="space_hardware" :gutter="30">
          <el-col :span="24">
            <el-descriptions title="You're using:" direction="vertical" :column="6" border>
              ...
              <el-descriptions-item label="Type">{{props.listdata.activeOrder.config.hardware_type}}</el-descriptions-item>
              ...
              <el-descriptions-item label="Price">{{props.listdata.activeOrder.config.price_per_hour}} LAG per hour</el-descriptions-item>
              <el-descriptions-item label="Description">{{props.listdata.activeOrder.config.description}}</el-descriptions-item>
            </el-descriptions>
          </el-col>
        </el-row>
      </div>
