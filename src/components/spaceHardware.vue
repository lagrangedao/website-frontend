        ...
        <div class="sleep_style">
          <div>
            ...
            <div class="time flex-row">
              <el-input-number v-model="ruleForm.usageTime" :min="0.1" :max="sleepSelect.hardware_type.indexOf('GPU') > -1? 168:336" :precision="1" :step="0.1" controls-position="right" /> &nbsp; hours
            </div>
          </div>
          <div v-if="props.renewButton !== 'renew'">
            <div class="title_tip flex-row">
