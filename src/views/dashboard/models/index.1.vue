...
export default defineComponent({
  ...
  setup () {
    ...
    async function init () {
      ...
      if (listRes) {
        listdata.value = listRes.spaces || []
        listdataAll.value = listRes.spaces || []
    ...
    return {
      ...
      bodyWidth,
      system,
      init, NumFormat, handleCurrentChange, handleSizeChange, momentFilter, detailFun, searchChange
    }
  }
})
</script>
            ...
            * {
            ...
            .el-card__body {
              ...
              .text {
                ...
                .icon_text {
                  background: url(../../../assets/images/icons/icon_39.png)
                    no-repeat left center;
                  background-size: 100%;
                }
                .icon_time {
            ...
            .box-card {
              ...
              .el-card__body {
                .text {
                  color: #fff;
                  .icon_text {
                    background: url(../../../assets/images/icons/icon_39_1.png)
                      no-repeat left center;
                    background-size: 100%;
                  }
                  .icon_time {
