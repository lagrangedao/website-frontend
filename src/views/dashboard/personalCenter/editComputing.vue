<template>
  <section id="access_token">
    <div class="token_list">
      <div class="title">As Computing Provider</div>
      <div class="card">
    ...
    <div class="token_list">
      ...
      <el-table :data="spData" stripe style="width: 100%" v-loading="listLoad">
        <el-table-column prop="name" label="Name" />
        <el-table-column prop="node_id" label="Node ID" />
        <el-table-column label="Created At" align="right" width="160">
        ...
        <el-table-column label="Updated At" align="right" width="160">
          <template #default="scope">
            <div>
        ...
        <el-table-column label="Action" align="right" width="70">
          <template #default="scope">
...
export default defineComponent({
  ...
  setup () {
    ...
    return {
      ...
      addVisible,
      ruleForm,
      getdataList, createCom, deleteCom, copyName, detailSetting, calculateDiffTime, momentFilter
    }
  }
})
</script>
