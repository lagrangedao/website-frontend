                    ...
                    <el-form-item prop="SDK">
                        <label class="label" for="SDK">
                            ...
                            <div class="flex flex-row">
                                ...
                                <el-radio-group v-model="ruleForm.sdk" @change="sdkChange" class="radio_flex flex-row">
                                    ...
                                    <el-radio label="VM" size="large" border>
                                        <i class="icon-vm"></i>
                                        VM
                                    </el-radio>
                                </el-radio-group>
...
export default defineComponent({
    ...
    setup () {
        ...
        return {
            ...
            depostForm,
            dialogWidth,
            submitForm, radioChange, handleChange, licenseChange, licenseQuery, ModelChangeSelect, sdkChange
        }
    },
});
</script>
                ...
                .el-radio {
                  ...
                  .el-radio__label {
                    ...
                    .icon-vm {
                      ...
                      margin: auto;
                      &.icon-vm {
                        background: url(../../../assets/images/icons/icon_53.png)
                          no-repeat center;
                        background-size: 100%;
                      }
                    }
