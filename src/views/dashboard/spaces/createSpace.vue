<template>
    <section id="space">
        <el-row class="space_body" v-loading="createLoad">
                ...
                <el-form ref="ruleFormRef" :model="ruleForm" :rules="rules" class="demo-ruleForm" status-icon>
                            ...
                            <div class="flex flex-row">
                                ...
                                <el-radio-group v-model="ruleForm.sdk" class="radio_flex">
                                    ...
                                    <el-radio label="Gradio" size="large" border>
                                        <svg class="h-6 w-6 w-auto" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" aria-hidden="true" focusable="false" role="img" width="1em" height="1em" preserveAspectRatio="xMidYMid meet" viewBox="0 0 16 16">
                                            <path d="M8.02295 1.98199L13.9998 5.25992V7.16976L8.02295 3.89183V1.98199Z" fill="#FF7C00" fill-opacity="0.75"></path>
                                            <path d="M13.9978 5.25958L7.99902 8.54986V10.472L13.9978 7.1817V5.25958Z" fill="#FF7C00"></path>
                                            <path d="M2 5.25958L7.99933 8.54986V10.472L2 7.18172V5.25958Z" fill="#FF7C00" fill-opacity="0.75"></path>
                                            <path d="M8.0228 1.96954L2.00098 5.25977V7.18191L8.0228 3.89169V1.96954Z" fill="#FF7C00"></path>
                                            <path d="M8.02295 5.29657L13.9998 8.57448V10.4843L8.02295 7.2064V5.29657Z" fill="#FF7C00" fill-opacity="0.75"></path>
                                            <path d="M13.9978 8.57452L7.99902 11.8648V13.7869L13.9978 10.4967V8.57452Z" fill="#FF7C00"></path>
                                            <path d="M2 8.57452L7.99933 11.8648V13.7869L2 10.4967V8.57452Z" fill="#FF7C00" fill-opacity="0.75"></path>
                                            <path d="M8.0228 5.28448L2.00098 8.57472V10.4968L8.0228 7.20664V5.28448Z" fill="#FF7C00"></path>
                                        </svg>
                                        Gradio
                                    </el-radio>
                    ...
                    <el-form-item prop="hardware">
                        <label class="label" for="hardware">
                            ...
                            <div class="flex flex-row">
                                <el-select v-model="ruleForm.hardware" placeholder="Select a hardware">
...
export default defineComponent({
    ...
    setup () {
        ...
        const ruleForm = reactive({
            ...
            license: '',
            resource: '1',
            hardware: 'CPU only · 2 VCPU · 16 GB · FREE',
            sdk: 'Streamlit'
        })
        const hardwareOptions = ref([
            {
                ...
                options: [
                    {
                        value: 'CPU only · 2 VCPU · 16 GB · FREE',
                        label: 'CPU only · 2 VCPU · 16 GB · FREE',
                    },
                    {
                        value: 'CPU only · 8 VCPU · 32 GB · S0.03 per hour',
                        label: 'CPU only · 8 VCPU · 32 GB · S0.03 per hour',
                    },
                ],
            },
            {
                ...
                options: [
                    {
                        value: 'Nvidia T4 · 4 VCPU · 15 GB · SO.60 per hour',
                        label: 'Nvidia T4 · 4 VCPU · 15 GB · SO.60 per hour',
                    },
                    {
                        value: 'Nvidia T4 · 8 VCPU · 30 GB · S0.90 per hour',
                        label: 'Nvidia T4 · 8 VCPU · 30 GB · S0.90 per hour',
                    },
                    {
                        value: 'Nvidia A10G · 4 VCPU · 15 GB · S1.05 per hour',
                        label: 'Nvidia A10G · 4 VCPU · 15 GB · S1.05 per hour',
                    },
                    {
                        value: 'Nvidia A10G · 12 VCPU · 46 GB · S3.15 per hour',
                        label: 'Nvidia A10G · 12 VCPU · 46 GB · S3.15 per hour',
                    },
                ],
            },
        ])
        ...
        onMounted(() => {
            ruleForm.name = ''
            ruleForm.license = ''
            ruleForm.hardware = 'CPU only · 2 VCPU · 16 GB · FREE'
            ruleForm.sdk = 'Streamlit'
        })
        return {
            metaAddress,
            navLogin,
